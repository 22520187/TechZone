        ...
        >
            <div className="relative">
                <div className="relative w-full aspect-square bg-gray-100 flex items-center justify-center overflow-hidden">
                    <img
                        src={
                            product.image && product.image.startsWith("/api")
                    ...
                    <Popconfirm
                        ...
                        placement="left"
                    >
                        <button className="absolute top-2 right-2 p-1.5 rounded-full bg-red-500 text-white hover:bg-red-600 transition-colors">
                            <Trash2 size={14} />
                        </button>
                    </Popconfirm>
                </div>
