        ...
        <div className="flex flex-col">
            ...
            <div className="flex space-x-2">
              {productDetail.productColors.map((color) => (
                <button
                  ...
                  className={`w-10 h-10 rounded-full border-2 cursor-pointer ${selectedColor?.id === color.id
                      ? "border-primary"
                      : "border-transparent"
                    } transform transition-transform ${selectedColor?.id === color.id ? "scale-110" : "scale-100"
                    } hover:scale-110`}
                  style={{
          ...
          {selectedColor && (
            <motion.button
              ...
              disabled={isPending}
              className={`w-full flex items-center justify-center gap-2 bg-gradient-to-br from-primary to-secondary cursor-pointer text-white py-2 rounded-lg hover:bg-gradient-to-br hover:from-primary-600 hover:to-secondary-600 transition-all ${isPending ? "opacity-70 cursor-not-allowed" : ""
                }`}
