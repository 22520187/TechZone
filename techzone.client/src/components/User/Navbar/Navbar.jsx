...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden fixed top-[57px] right-0 h-screen w-[300px] bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 ${isMenuOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
