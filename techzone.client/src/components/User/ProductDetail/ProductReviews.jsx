              ...
              return (
                <div key={rating} className="flex items-center">
                  <button
                    ...
                    className={`flex items-center space-x-2 min-w-[60px] text-sm ${filter === rating
          ...
          <div className="mt-4 flex items-center justify-between">
            <div className="flex space-x-2 space-y-2 flex-wrap">
              <Button
                ...
                className={`text-xs h-8 ${filter === null ? "bg-primary/10 border-primary/30" : ""
                  }`}
              >
                All
              </Button>
              {[5, 4, 3, 2, 1].map((rating) => (
                <Button
                  ...
                  size="sm"
                  onClick={() => setFilter(filter === rating ? null : rating)}
                  className={`text-xs h-8 ${filter === rating ? "bg-primary/10 border-primary/30" : ""
                    }`}
                >
                  {rating}★
                </Button>
