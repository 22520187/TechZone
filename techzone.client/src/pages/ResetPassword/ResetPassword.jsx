...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Gửi API đổi mật khẩu với code
      const response = await api.post("api/account/forgot-reset-password", {
        email,
        code,
        ...
        {!isSubmitted ? (
          ...
          >
            ...
            >
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className={`mt-1 block w-full p-2 border rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 ${
              ...
              {errorPass && (
                <p className="text-sm text-red-600 font-medium">{errorPass}</p>
              )}
