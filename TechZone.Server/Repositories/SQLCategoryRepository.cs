...
{
    public class SQLCategoryRepository : TechZoneRepository<Category>, ICategoryRepository
    {
        public SQLCategoryRepository(TechZoneDbContext dbContext) : base(dbContext)
        {
        }
