...
{
    public class TechZoneRepository<T> : ITechZoneRepository<T> where T : class
    {
        protected readonly TechZoneDbContext dbContext;
        protected DbSet<T> _dbSet;
        public TechZoneRepository(TechZoneDbContext dbContext)
        {
